...
export default function NowPlaying() {
  ...
  return (
    <>
      {data?.songUrl ? (
        <div className="flex flex-col align-middle justify-center items-center mx-auto">
          <img src={data?.albumImageUrl} className="w-20 h-20" />
        </div>
      ) : (
        <></>
      )}
      <div className="flex flex-row items-center justify-center w-full sm:flex-row mb-8 mx-auto space-x-0 sm:space-x-2 w-100">
        {data?.songUrl ? (
          <AnimatedBars />
        ) : (
        ...
        <div className="inline-flex flex-col sm:flex-row w-full truncate">
          {data?.songUrl ? (
            <a
