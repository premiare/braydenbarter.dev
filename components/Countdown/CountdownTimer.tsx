...
export const AnimatedCountdown = ({
  ...
  return (
    <span className="flex flex-row ml-[2px] first:px-0">
...
export const CountdownTimer = ({
  ...
  return (
    <>
      <div className="flex flex-row items-center justify-center text-center md:text-start">
        <p className="w-full flex flex-wrap indent-1 md:flex-row">
          My last commit was{" "}
